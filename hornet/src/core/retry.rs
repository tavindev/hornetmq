...
mod tests {
    ...
    fn fixed_strategy_delay() {
        ...
        assert_eq!(next_retry_delay(&strategy, 1), 2000);
        assert_eq!(next_retry_delay(&strategy, 3), 2000);
    }
    ...
    fn exponential_strategy_delay() {
        ...
        assert_eq!(next_retry_delay(&strategy, 1), 500);
        assert_eq!(next_retry_delay(&strategy, 2), 1000);
        assert_eq!(next_retry_delay(&strategy, 3), 2000);
    }
}
